...
abstract class _CappedProgressIndicator extends StatefulWidget {
  ...
  /// The progress indicator's gradient background.
  ///
  /// It is up to the subclass to implement this in whatever way makes sense
  /// for the given use case. See the subclass documentation for details.
  final ui.Gradient? gradientBackground;
...
class CircularCappedProgressIndicator extends _CappedProgressIndicator {
  ...
  @override
  State<CircularCappedProgressIndicator> createState() =>
      _CircularCappedProgressIndicatorState();
}

class _CircularCappedProgressIndicatorState
    extends State<CircularCappedProgressIndicator>
      ...
      child: Container(
        ...
        child: CustomPaint(
          painter: _CircularCappedProgressIndicatorPainter(
            ...
            gradientBackground: widget.gradientBackground,
