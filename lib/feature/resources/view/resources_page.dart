      ...
      body: CustomScrollView(
        slivers: [
          SectionSliverAppBar.svg(
            title: 'Resources',
            iconBackgroundColor: WoColors.purple,
          ...
          SliverPadding(
            ...
            sliver: SliverList.list(
              children: const [
                ...
                SizedBox(height: Spacing.s_16),
                ResourceCard(
                  title: 'Navigating the Woilian Workplace',
                  path:
                      'https://www.veteransemployment.gov.au/veterans/civilian-workplace',
                  content:
                      'Woilian workplace culture can be quite different to the ADF.',
                ),
                SizedBox(height: Spacing.s_16),
                ResourceCard(
...
class _ResourceCardState extends State<ResourceCard>
  ...
  Widget build(BuildContext context) {
    ...
    return WoCard(
      ...
      child: WoText.bodyMedium(widget.content),
    );
  }
}
