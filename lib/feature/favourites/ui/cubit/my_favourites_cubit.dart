...
class MyFavouritesCubit extends Cubit<MyFavouritesState> {
  MyFavouritesCubit({required this.favouritesRepository})
      : super(const MyFavouritesState.loading());
...
sealed class MyFavouritesState with _$MyFavouritesState {
  ...
  const factory MyFavouritesState.loaded(
      {required List<Favourite> favourites}) = MyFavouritesStateLoaded;
}
