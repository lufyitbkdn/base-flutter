            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: CivText.bodyMedium(
                    'View the items you have favourited throughout the CivStart app. You can favourite items from our Job Search Steps, Tips and Tricks, and Resources pages.'),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return SliverList.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          padding: const EdgeInsets.symmetric(
              horizontal: kContentPaddingSpacing, vertical: Spacing.xs_8),
          child: CivCard(
