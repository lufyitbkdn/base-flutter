          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: WoText.bodyMedium(
                  'View the items you have favourited throughout the WoStart app. You can favourite items from our Job Search Steps, Tips and Tricks, and Resources pages.',
                ),
              ),
            ),
            BlocBuilder<MyFavouritesCubit, MyFavouritesState>(
              ...
              builder: (context, state) {
                return switch (state) {
                  MyFavouritesStateLoading() ||
                  MyFavouritesStateError() =>
                  ...
                  MyFavouritesStateLoaded() => state.favourites.isEmpty
                      ...
                      : SliverPadding(
                          ...
                          sliver:
                              FavouritesSliver(favourites: state.favourites),
                        ),
                };
              },
            ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: WoText.titleMedium("You don't have any favourites"),
        ),
        const Spacer(flex: 2),
      ],
    );
