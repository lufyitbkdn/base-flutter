        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.m_25),
              WoText.titleMedium('Intellectual Property'),
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium(
              ...
              const SizedBox(height: Spacing.m_25),
              WoText.titleMedium('Jurisdiction and Limitation'),
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium(
