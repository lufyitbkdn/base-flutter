...
enum Skill {
  adaptability(
    ...
    description:
        "Adaptability can be defined as your ability to adjust to a change in conditions. Being able to learn from your mistakes and experiences help with your adaptability skill. An adaptable person is someone who is willing to experiment and test their ideas and learn from their results. In most cases, they don't see a mistake as a failure but instead take this upon them as a learning experience and a new opportunity. Being adaptable means that you can think ahead and are able to push forward when issues arise.",
  ),
  attentionToDetail(
...
class ScoredSkillQuestion with _$ScoredSkillQuestion {
  ...
  factory ScoredSkillQuestion.fromJson(Map<String, dynamic> json) =>
      _$ScoredSkillQuestionFromJson(json);
}
...
class RankedHardSkill with _$RankedHardSkill {
  ...
  factory RankedHardSkill.fromJson(Map<String, dynamic> json) =>
      _$RankedHardSkillFromJson(json);
}
