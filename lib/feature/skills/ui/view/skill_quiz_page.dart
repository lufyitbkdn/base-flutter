        ...
        children: [
          PaddedContent(
            children: [
              ...
              WoText.titleMedium('Know your Soft Skills'),
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium(
...
class _SkillsQuizQuestionsState extends State<SkillsQuizQuestions> {
  ...
  Widget build(BuildContext context) {
    ...
    final textScaleFactor = max(MediaQuery.of(context).textScaler.textScaleFactor, 1);
...
class SkillQuizItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        WoText.titleMedium(scoredQuestion.skillQuestion.question),
        const SizedBox(height: Spacing.s_16),
        Slider(
          max: 7,
          divisions: 7,
        ...
        Row(
          children: [
            WoText.labelMedium('Strongly\nDisagree'),
            const Spacer(),
            DefaultTextStyle.merge(
              textAlign: TextAlign.end,
              child: WoText.labelMedium('Strongly\nAgree'),
            ),
          ],
        ),
      ],
