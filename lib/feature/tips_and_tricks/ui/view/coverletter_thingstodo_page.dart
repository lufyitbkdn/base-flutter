...
class CoverLetterThingsToDoPage extends StatefulWidget {
  ...
  @override
  State<CoverLetterThingsToDoPage> createState() =>
      _CoverLetterThingsToDoPageState();
}

class _CoverLetterThingsToDoPageState extends State<CoverLetterThingsToDoPage>
