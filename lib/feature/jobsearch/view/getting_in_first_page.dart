...
class _GettingInFirstPageState extends State<GettingInFirstPage>
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium('Your Target List and Marketing Plan'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
