...
class _YouHaveLandedARolePageState extends State<YouHaveLandedARolePage>
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium(
                  "Congratulations! You've landed! Your job search has ended. But your career is just beginning a new chapter! Some things to consider...",),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium('Transition Planning:'),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Reading the Culture',
                child: WoText.bodyMedium(
                    "Understand 'this is the way we do things around here' Identify the cultural norms and styles of the company, your manager, peers and direct reports, and understand the differences in your style and the company's culture.",),
              ),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Building Alliances and Influencing Others',
                child: WoText.bodyMedium(
                    "You're new. Your appointment creates “change”. Be mindful of managing change. Build relationships and understand what is important to individuals or teams in the company.",),
              ),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Determine and Align Expectations',
                child: WoText.bodyMedium(
                    'Understand what business priorities are expected, and establish agreement on what success will look like and how it will be measured.',),
              ),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Focus on Early Impact Projects',
                child: WoText.bodyMedium(
                    'Identify early-impact projects where you can show your value quickly, but ensure you have a balance between early-impact projects and long-term focuses.',),
              ),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Your Professional Environment and Objective',
                child: WoText.bodyMedium(
                    'Stay aware of what is happening in the market, refine where you want your career to go and occasionally embark on a healthy self-assessment.',),
              ),
              const SizedBox(height: Spacing.s_16),
              WoCard(
                title: 'Always have a Communications Strategy',
                child: WoText.bodyMedium(
                    'Acknowledge the importance of communicating your value, successes, and strengths and maintain your credibility in the market, and keep your CV up to date!',),
              ),
