...
class _BeforeYouBeginPageState extends State<BeforeYouBeginPage>
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.bodyMedium(
                  "It's time to focus on looking for that next role.",),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              WoText.bodyMedium(
                  'Before we get started, here are some helpful things to remember.',),
              const SizedBox(height: Spacing.s_16),
              WoText.titleMedium('Dealing with Stories and Myths'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.titleMedium('Keeping on Track'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.titleMedium('Time Management'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.titleMedium('Emotional Survival Tactics'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              WoText.titleMedium('Financial Assistance'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
