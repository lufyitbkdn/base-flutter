...
class WhatElseShouldIBeDoingPage extends StatefulWidget {
  ...
  @override
  State<WhatElseShouldIBeDoingPage> createState() => _WhatElseShouldIBeDoingPageState();
}

class _WhatElseShouldIBeDoingPageState extends State<WhatElseShouldIBeDoingPage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Consider all search methods to work out which methods suit you and your search best. There are several ways to go about your job search including:'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Here are some tips for using recruiters and job boards.'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(
                bullets: [
