...
class TalkingToTheRightPeoplePage extends StatefulWidget {
  ...
  @override
  State<TalkingToTheRightPeoplePage> createState() => _TalkingToTheRightPeoplePageState();
}

class _TalkingToTheRightPeoplePageState extends State<TalkingToTheRightPeoplePage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("Being in the right place at the right time isn't an accident - it's the result of good planning. It takes only one person to decide to hire you, but it takes many conversations with hiring managers to uncover the right opportunity. Talking with people who make hiring decisions is the single most important activity in a job search. And talking with hiring managers in your chosen target organisations, before there is an opening, raises your odds immensely and shortens your search time."),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("You need to know who the hiring managers are and work your network to get introductions or connections to these individuals. If your target list research is thorough, you know who they are. Your networking will help you reach insiders within your target organisations - peers and referrals - and with some further networking, you can ultimately be introduced to the hiring managers. Sometimes it takes time - but it's worth it."),
              const SizedBox(height: Spacing.s_16),
              CivText.titleMedium('Networking - Hiring Managers'),
              const SizedBox(height: Spacing.s_16),
              ...
              CivText.bodyMedium('Even without a specific opening, these meetings need to be treated like an interview - sooner or later they will have a need and you want to be the prime candidate considered. Or, you want them to feel so confident of the value you can bring, that they create a role for you.'),
