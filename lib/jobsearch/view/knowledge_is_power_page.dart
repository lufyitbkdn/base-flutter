...
class _KnowledgeIsPowerPageState extends State<KnowledgeIsPowerPage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('The more you know, the shorter your job search will be. The right kind of knowledge is essential in a job search and allows you to make better decisions, create a better impression when networking and in interviews and leverage introductions to the right people. Having information about your target companies, industries, professions - and people - helps you prioritise your Target List.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Knowledge comes from research, and research is an activity that needs thought. Think carefully about what you already know and what you need to uncover. Online resources, other people - and of course, LinkedIn, are great sources of information for your job search.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("Networking - talking to people - is key to search success - you do it every day without knowing that you do it and in job search it's essential."),
              const SizedBox(height: Spacing.s_16),
              CivText.titleMedium('Research and Marketplace Information'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('When researching, you should ask yourself the following questions:'),
              const SizedBox(height: Spacing.s_16),
