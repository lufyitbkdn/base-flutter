...
class _YourCVAndProfilePageState extends State<YourCVAndProfilePage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('How is your advertising campaign going? In a job search, you must have an advertising campaign - communications strategy - to deliver a consistent message about yourself across a number of areas.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('A planned communications strategy helps you have harmony across three areas:'),
              const SizedBox(height: Spacing.s_16),
              ...
              CivText.bodyMedium("Your written communications strategy - your CV and cover letter - it's all about what you do best - your achievements!"),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('Your Summary Statement/Profile is the umbrella over your CV.'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('Cover Letters/Emails - Unless expressly told not to, you should always send a cover letter/email with your CV.'),
              const SizedBox(height: Spacing.s_16),
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("LinkedIn - a professional 'must'. It is for the people you need to be connected to, across your profession, your industry, like-minded professionals who share information, referrals, leads and 'thought leadership' similar to your own knowledge and awareness - essential in a job search."),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Your online presence - consistency, credibility and a good reputation.'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
