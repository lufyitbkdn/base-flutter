          ...
          PaddedContent(
            children: [
              ...
              ListTileButton.svg(
                ...
                onPressed: () => context.goNamed(UnderstandingTheJobLandscapePage.routeName),
              ),
              const SizedBox(height: Spacing.s_16),
              ListTileButton.svg(
                ...
                onPressed: () => context.goNamed(YourProfessionalObjectivesPage.routeName),
              ),
              const SizedBox(height: Spacing.s_16),
              ListTileButton.svg(
                ...
                onPressed: () => context.goNamed(YourCVAndProfilePage.routeName),
              ),
              const SizedBox(height: Spacing.s_16),
              ListTileButton.svg(
