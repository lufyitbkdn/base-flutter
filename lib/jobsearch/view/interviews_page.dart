...
class _InterviewsPageState extends State<InterviewsPage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              CivText.bodyMedium('Preparation is key, read the job description carefully, several times! You can almost predict the questions that you might be asked. Preparing answers to standard questions and competency-based questions will give you a massive advantage in an interview against someone who does not prepare.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('This is a great opportunity to practise your STAR question answers.'),
              const SizedBox(height: Spacing.m_25),
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('You will typically have an hour to get your core message across convincingly. That means preparation is the key.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("During the Interview, it's not just about your answers to questions. This is a two-way discussion between professionals, your questions are important too."),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Questions you can ask at an interview:'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('Pick me! To get an offer the interviewer needs to hear, see and feel your enthusiasm for the role.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("During (and after) the interview, the single best way to communicate your interest and enthusiasm is simply saying “I really want this job” or “I'm very interested in this job, I'd really like to be offered this role”. You do need to back this up by confirming you have the right qualifications, skills and experience for the position but above all the interviewer wants to sense your positive attitude towards the role."),
              const SizedBox(height: Spacing.m_25),
              Image.asset(
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.titleMedium("Negotiating - it's vital to take a “win-win” stance"),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Almost everything about an offer is (potentially) negotiable, so you need to be clear about what is important enough to talk about, and what you will accept. Take a win-win stance. Research plays an important part in this strategy as does “give and take”. The more work you do beforehand considering what you will and will not accept, the better your negotiating position.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("Second interviews are different, they delve deeper into “fit” areas, checking your match to the role. Don't relax your activities because you have a second interview. Keep up your activity - you could find yourself back to square one!"),
