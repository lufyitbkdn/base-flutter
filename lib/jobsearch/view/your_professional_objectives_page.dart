...
class YourProfessionalObjectivesPage extends StatefulWidget {
  ...
  @override
  State<YourProfessionalObjectivesPage> createState() => _YourProfessionalObjectivesPageState();
}

class _YourProfessionalObjectivesPageState extends State<YourProfessionalObjectivesPage> with FavouritablePageMixin {
  @override
        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('You need to be able to talk about your skills - including your strongest skills - to anyone who asks about them and these can fall across a couple of categories:'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              CivText.bodyMedium('Analysing and identifying the things you achieve daily, weekly, and monthly as well as the "Key Achievements" you have accomplished throughout your career to date helps you confirm the skills that you use when you are successful.'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("You need to be able to tell people about your skills in a positive, succinct way and speak about your skills, on the phone, in person and online. You'll also elaborate on your skills at the interview by responding to behavioural or competency-based questions about examples or demonstrations of your skills. The STAR technique can help!"),
              const SizedBox(height: Spacing.s_16),
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('As you develop your professional objective, concentrate on developing your “brand” - you need an online presence that makes a positive impression, uniquely about you, consistent with your communications strategy, so that what you say about yourself in person is echoed online.'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("You need to be found for the right reasons! (your branding). Personal branding is more than just an elevator speech or a couple of buzzwords - it's about who you are and how you appear to potential hiring managers."),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('What image defines you?'),
              const SizedBox(height: Spacing.s_16),
              const BulletList(bullets: [
              ...
              const SizedBox(height: Spacing.m_25),
              CivText.bodyMedium('Online Branding: The best-known brands have established an online presence in the minds of their audiences. How about you?'),
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium("You might be a little uncomfortable at 'blowing your own trumpet', but unless you market your skills and their value to your audience, you won't get the attention you deserve. Your Online Brand should tell the hiring world: 'This is who I am and what I do'. If it does it well, your online brand will help you stand out from the crowd."),
