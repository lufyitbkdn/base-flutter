          ...
          SliverPadding(
            ...
            sliver: SliverList.list(
              children: [
                ...
                CivText.bodyMedium('To be a good performer, you need a mix of both soft and hard skills.'),
                const SizedBox(height: Spacing.s_16),
                ListTileButton.svg(
                  svgPath: Assets.assets_images_ico_quiz_svg,
                  color: CivColors.blue,
                  title: 'Skills Quiz',
                  subtitle: 'Take the skills quiz to find out your soft skills.',
                ...
                BlocBuilder<MySkillsCubit, MySkillsState>(
                  ...
                  builder: (context, state) {
                    return ListTileButton.svg(
                      ...
                      subtitle: 'Personality traits, attitudes, and behaviours—things that come naturally to you.',
                      onPressed: () {
                        final nextRoute = switch (state) {
                          MySkillsStateHasSkillTest() => SoftSkillsPage.routeName,
                          MySkillsStateLoading() => SkillQuizNotCompletedPage.routeName,
                          MySkillsStateHasNotSkillTest() => SkillQuizNotCompletedPage.routeName,
                        };
                ...
                ListTileButton.svg(
                  ...
                  subtitle: 'Specific abilities and capabilities that you have learnt and can demonstrate.',
