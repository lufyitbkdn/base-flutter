            ...
            children: [
              ...
              BlocBuilder<SoftSkillsCubit, SoftSkillsState>(
                ...
                builder: (context, state) {
                  return switch (state) {
                    SoftSkillsStateLoading() || SoftSkillsStateErrorLoading() => const Padding(
      ...
      children: [
        ...
        SkillSection(
          ...
          imagePath: switch (topSkills.first) {
            ...
            Skill.attentionToDetail => Assets.assets_images_attention_to_detail_skill_png,
            ...
            Skill.problemSolving => Assets.assets_images_problem_solving_skill_png,
            Skill.teamwork => Assets.assets_images_teamwork_skill_png,
            Skill.timeManagement => Assets.assets_images_time_management_skill_png,
...
class _SkillSectionState extends State<SkillSection> {
  ...
  Widget build(BuildContext context) {
    ...
    const radius = 5.0;
    final titleToCardSpacing = Spacing.s_16 - (widget.imagePath == null ? 0 : radius);
                ...
                child: Column(
                  children: [
                    for (int i = 0; i < expandedSkills.length; ++i)
                      ExpansionTile(
                        title: CivText.titleMedium(expandedSkills[i].item.fullName),
                        ...
                        shape: Border(
                          top: BorderSide(
                            color: isFirst(i) ? Colors.transparent : dividerColor,
                            width: isFirst(i) ? 0.0 : 0.5,
                          ),
                          bottom: BorderSide(
                            color: isLast(i) ? Colors.transparent : dividerColor,
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: Spacing.s_16, right: Spacing.s_16, bottom: Spacing.s_16),
                            child: CivText.bodyMedium(expandedSkills[i].item.description),
                          ),
                        ],
                      ),
                  ],
