        ...
        children: [
          PaddedContent(
            children: [
              ...
              const SizedBox(height: Spacing.s_16),
              CivText.bodyMedium('Soft skills are a combination of both social, interpersonal, character or personality traits and attitudes. They can be learnt, expanded and increased. So if you feel you lack in some, the good news is you can improve with practise and exercises.'),
                ...
                builder: (context, state) {
                  return switch (state) {
                    ...
                    SkillsQuizStateTakingSkillsQuiz() => SkillsQuizQuestions(
                        ...
                        onNextPressed: state.canSaveQuestions ? bloc.saveQuestions : bloc.goToNextQuestion,
...
class _SkillsQuizQuestionsState extends State<SkillsQuizQuestions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        CivText.labelMedium('Question ${widget.currentQuestionIndex + 1} of ${widget.scoredQuestions.length}'),
        SizedBox(
        ...
        Row(
          children: [
            CivButton.primaryOutlined(
              title: 'Back',
              onPressed: widget.canGoToPreviousQuestion ? widget.onBackPressed : null,
            ),
            const Spacer(),
