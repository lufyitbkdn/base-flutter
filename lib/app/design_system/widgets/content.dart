        ...
        SliverToBoxAdapter(
          child: Column(
            ...
            children: [
              ...
              PaddedContent(children: [CivText.titleLarge(title)]),
...
class CivSliverAppBar extends StatelessWidget {
  const CivSliverAppBar({super.key, this.actions});
        ...
        for (final bullet in bullets) ...[
          Row(
            ...
            children: [
              ...
              const SizedBox(width: Spacing.s_16),
              Expanded(
                child: CivText.bodyMedium(bullet),
              ),
            ],
          ),
