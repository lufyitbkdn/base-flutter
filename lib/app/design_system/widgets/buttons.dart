...
class WoButton extends StatelessWidget {
  const WoButton.primaryFilled({
    required this.title,
    super.key,
    this.onPressed,
  }) : _buttonKind = _ButtonKind.primaryFilled;

  const WoButton.primaryOutlined({
    required this.title,
    super.key,
    this.onPressed,
  }) : _buttonKind = _ButtonKind.primaryOutlined;

  const WoButton.secondaryFilled({
    required this.title,
    super.key,
    this.onPressed,
  }) : _buttonKind = _ButtonKind.secondaryFilled;

  const WoButton.secondaryOutlined({
    required this.title,
    super.key,
    this.onPressed,
