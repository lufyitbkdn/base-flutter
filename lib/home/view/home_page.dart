...
import 'package:civstart/jobsearch/view/jobsearch_page.dart';
import 'package:civstart/resources/view/resources_page.dart';
...
class _HomePageState extends State<HomePage> {
  Future<void> showWelcomeDialogIfNecessary() async {
    ...
    final hasSeenWelcomeMessage = await homeRepository.loadHasSeenWelcomeMessage();
    if (!hasSeenWelcomeMessage) {
      WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
        await showDialog<void>(context: context, builder: (context) => const HomePageDialog());
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            actions: [
              IconButton(onPressed: () => context.goNamed(MoreInformationPage.routeName), icon: const Icon(Icons.info_outline)),
            ...
            sliver: SliverList.list(
              children: [
                ListTileButton.svg(
                  ...
                  title: 'My Skills',
                  subtitle: 'Complete our quiz and learn about your soft and hard skills.',
                ...
                ListTileButton.svg(
                  ...
                  subtitle: 'Follow these steps to help you succeed with your job search.',
                ...
                ListTileButton.svg(
                  ...
                  subtitle: 'Tips to help with your CV, cover letter, network and interviews.',
