...
import 'package:civstart/favourites/data/models/favourites_data.dart';
...
class FavouritesRepository {
  ...
  Future<Set<Favourite>> getFavourites() async {
    ...
    return _favouritesCache = deserializeJsonList(favouritesDataString, Favourite.fromJson).toSet();
  }
