...
class NetworkingThingsToDoPage extends StatefulWidget {
  ...
  @override
  State<NetworkingThingsToDoPage> createState() => _NetworkingThingsToDoPageState();
}

class _NetworkingThingsToDoPageState extends State<NetworkingThingsToDoPage> with FavouritablePageMixin {
  @override
