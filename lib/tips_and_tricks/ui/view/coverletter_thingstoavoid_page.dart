...
class CoverLetterThingsToAvoidPage extends StatefulWidget {
  ...
  @override
  State<CoverLetterThingsToAvoidPage> createState() => _CoverLetterThingsToAvoidPageState();
}

class _CoverLetterThingsToAvoidPageState extends State<CoverLetterThingsToAvoidPage> with FavouritablePageMixin {
  @override
