...
class _CVGeneralTipsPageState extends State<CVGeneralTipsPage> with FavouritablePageMixin {
  @override
          ...
          PaddedContent(
            children: [
              ...
              CivListTile.svg(
                ...
                subtitle: 'A few sentences or bullet points to outline accountabilities or responsibilities.',
              ),
              const SizedBox(height: Spacing.s_16),
              CivListTile.svg(
                svgPath: Assets.assets_images_ico_brain_svg,
                ...
                subtitle: 'Bullets to overview achievements with business results/outcomes.',
              ),
              const SizedBox(height: Spacing.s_16),
              CivListTile.svg(
                svgPath: Assets.assets_images_ico_brain_svg,
                ...
                subtitle: 'If you had multiple positions at one company: give full employment dates first then dates for each position.',
              ),
              const SizedBox(height: Spacing.s_16),
              CivListTile.svg(
                svgPath: Assets.assets_images_ico_brain_svg,
