...
class AfterInterviewCheckListRepository extends CheckListRepository {
  ...
  final checkList = [
    const CheckListItem(
      title: 'Sit down somewhere comfortable and review your notes ASAP - think about the interview, start to finish, recall information that passed between you and the interviewer(s)',
    ...
    const CheckListItem(title: 'Does the role make sense? Do I feel clear on all the information?', isChecked: false),
    const CheckListItem(
    ...
    const CheckListItem(
      title: "Within the next business day, send an email to the interviewer - thank them for their time, confirm my interest in the role, ask for any further information that I may need. This is important - it's one of the biggest differentiators, and it puts you at the forefront of the interviewer's mind - again!",
      isChecked: false,
    ),
  ];
}
